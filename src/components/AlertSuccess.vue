<template>
    <div class="p-10 flex flex-col space-y-3">
        <div class="bg-blue-100 p-5 w-full sm:w-1/2 lg:w-1/4 rounded-md">
        ...
        <div class="bg-green-100 p-5 w-full sm:w-1/2 lg:w-1/4 rounded-md">
        ...
        <div class="bg-red-100 p-5 w-full sm:w-1/2 lg:w-1/4 rounded-md">
            <div class="flex space-x-3">
