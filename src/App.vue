<template>
  ...
  <div class="h-screen w-screen">
        ...
        <div class="px-4 py-6 sm:px-0 lg:py-10 max-w-7xl mx-auto">
          ...
          <div class="lg:flex lg:justify-between pb-4">
            ...
            <div class="mt-5 flex lg:mt-0 lg:ml-4">
              <span class="block">
                <button type="button" class="inline-flex items-center rounded-md border border-gray-500 bg-secondary px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-gray-700 focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:ring-offset-1">
              ...
              <span class="ml-2">
                <button
                  type="button"
                  @click="openModalAddCourse"
                  class="inline-flex items-center rounded-md border border-pepper-primary bg-pepper-primary px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-danger-700 focus:outline-none focus:ring-1 focus:ring-danger-500 focus:ring-offset-1">
                  <PlusIcon class="-ml-1 mr-1 h-4 w-4 font-bold" aria-hidden="true" />
                  Adicionar curso
                </button>
              </span>
          ...
          <div class="py-10">
            ...
            <div class="md:flex md:items-center mb-8 lg:mb-10">
              ...
              <!-- Button -->
              <button type="button"
                class="md:ml-6 lg:ml-8 inline-flex items-center rounded-md bg-gray-800 border-gray-800 px-3 py-2 text-xs font-semibold text-gray-200 hover:bg-opacity-40 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75">
              ...
              <!-- Button -->
              <button type="button"
                class="ml-1 inline-flex items-center rounded-md bg-gray-800 border-gray-800 px-3 py-2 text-xs font-semibold text-gray-200 hover:bg-opacity-40 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75">
    ...
    <TransitionRoot appear :show="isOpenAddCourse" as="template">
      <Dialog as="div" @close="closeModalAddCourse" class="relative z-50">
        <TransitionChild
          as="template"
                  ...
                  <form action="#" method="POST">
                    ...
                    <div class="mb-4">
                      ...
                      <input
                        ...
                        class="border-primary text-gray-700 text-sm placeholder-gray-400 focus:border-indigo-500 w-full rounded-md border-[1.5px] py-3 px-3 font-medium outline-none transition disabled:cursor-default disabled:bg-[#F5F7FD]" />
                    </div>
...
// Modal 'Add Course'
const isOpenAddCourse = ref(false)

function closeModalAddCourse() {
  isOpenAddCourse.value = false
}
function openModalAddCourse() {
  isOpenAddCourse.value = true
}
