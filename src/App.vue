          ...
          <div class="py-10">
            ...
            <div class="md:flex md:items-center mb-8 lg:mb-10">
              ...
              <div class="inline-flex md:mt-1">
                <!-- Button -->
                <button type="button"
                  class="md:ml-6 lg:ml-8 inline-flex items-center rounded-md border border-gray-600 bg-secondary px-3 py-2 text-xs font-medium text-white shadow-sm hover:bg-gray-700 focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:ring-offset-1">
                ...
                <!-- Button -->
                <button type="button"
                  class="ml-1 inline-flex items-center rounded-md border border-gray-600 bg-secondary px-3 py-2 text-xs font-medium text-white shadow-sm hover:bg-gray-700 focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:ring-offset-1">
